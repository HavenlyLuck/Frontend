...
const CONFETTI_COLORS = ['#7c6aff', '#a78bfa', '#f5c542', '#4ade80', '#ff6b8a', '#ff8c5a', '#60a5fa', '#fff']

interface Particle {
  x: number; y: number; w: number; h: number
  color: string; speed: number; angle: number; spin: number; drift: number
}
    ...
    <>
        ...
        <div className="main-content">
          ...
          <div className="summary-grid">
            <div className="summary-card">
              ...
              <div className="summary-value">2 <span>건</span></div>
              <div className="summary-label">진행 중인 응모</div>
            </div>
            <div className="summary-card">
              <div className="summary-icon">🏆</div>
              <div className="summary-value">3 <span>회</span></div>
              <div className="summary-label">누적 당첨</div>
            </div>
            <div className="summary-card">
              <div className="summary-icon">💸</div>
              <div className="summary-value">8,000 <span>원</span></div>
              <div className="summary-label">이번 달 응모 금액</div>
            </div>
            <div className="summary-card">
              <div className="summary-icon">🤍</div>
              <div className="summary-value">8 <span>개</span></div>
          ...
          <div className="entry-list">
            <Link className="entry-item" href="/products/notebook">
              ...
              <div className="entry-info">
                <div className="entry-title">반다이 맥시매틱 젠인 나오야 피규어[미개봉]</div>
              ...
              <div className="entry-status">
                <button className="btn-win-confirm" onClick={openWinModal}>🎉 당첨확인</button>
            ...
            <Link className="entry-item" href="/products/iphone">
              ...
              <div className="entry-info">
                <div className="entry-title">아이폰 14 Pro 256GB 스페이스 블랙</div>
                <div className="entry-meta">
                  <span>🎟 2장 응모</span>
                  <span>📅 오늘</span>
            ...
            <Link className="entry-item" href="/products/notebook">
              ...
              <div className="entry-info">
                <div className="entry-title">플레이스테이션 5 디스크 에디션</div>
                <div className="entry-meta">
                  <span>🎟 2장 응모</span>
                  <span>📅 3일 전</span>
          ...
          <div className="wish-grid">
            {[
              { emoji: '🎵', title: '소니 WH-1000XM5 헤드폰', price: '250,000원', badge: '🎟 응모 중 · 4일 남음' },
              { emoji: '📷', title: '소니 ZV-E10 미러리스 카메라', price: '380,000원', badge: '🎟 응모 중 · 7일 남음' },
              { emoji: '🖥️', title: '아이패드 Air 5세대 64GB', price: '480,000원', badge: '🎟 응모 중 · 6일 남음' },
            ].map(item => (
              <Link key={item.title} className="wish-card" href="/products/notebook">
          ...
          <div className="notif-list">
            <div className="notif-item unread">
              ...
              <div className="notif-text">
                <div className="notif-title">
                  ...
                  <strong style={{ color: '#4ade80' }}>당첨</strong>되셨습니다! 판매자에게 연락해 거래를 진행해주세요.
                </div>
            ...
            <div className="notif-item unread">
              ...
              <div className="notif-text">
                <div className="notif-title">
                  ...
                  <strong style={{ color: '#ff8c5a' }}>8시간</strong> 남았습니다.
                </div>
            ...
            <div className="notif-item unread">
              ...
              <div className="notif-text">
                <div className="notif-title">
                  관심 상품 <strong>소니 WH-1000XM5</strong>에 새로운 응모자가 15명 추가되었습니다.
                </div>
            ...
            <div className="notif-item">
              ...
              <div className="notif-text">
                <div className="notif-title">
                  <strong>에어팟 프로 2세대</strong> 응모에서 미당첨되셨습니다. 다음 기회에 다시 도전해보세요!
                </div>
      ...
      <canvas
        ...
        style={{
          ...
          zIndex: 600, width: '100%', height: '100%', display: 'none',
        }}
      />
      ...
      <div
        ...
        onClick={e => { if (e.target === e.currentTarget) closeWinModal() }}
      >
        <div className="win-modal">
          ...
          <div className="win-product">
            반다이 맥시매틱 젠인 나오야 피규어[미개봉]<br />
            <span style={{ color: '#7c6aff', fontWeight: 700 }}>28,000원</span> 상당의 상품에 당첨!
          </div>
          <button className="win-close" onClick={closeWinModal}>확인</button>
        </div>
      </div>
    </>
  )
