...
import { CoinsIcon, GiftIcon, StorefrontIcon, TicketIcon } from '@phosphor-icons/react'
...
const highlight: React.CSSProperties = { ...sentenceStyle, fontWeight: 700, color: 'var(--gold)' }

const sectionTitle: React.CSSProperties = {
  fontSize: 28, fontWeight: 700, color: 'var(--text)', marginBottom: 16,
      ...
      <div className="home-container" style={{ maxWidth: 800 }}>
        ...
        <section style={{ marginBottom: 56 }}>
          <h2 style={sectionTitle}>
            <CoinsIcon size={26} weight="fill" color="var(--accent)" /> 포인트
          </h2>
          <div style={box()}>
            ...
            <span style={highlight}>언제든 남은 🎰 운포인트는 현금으로 다시 변환하실 수 있습니다.</span>
          </div>
          <div style={box()}>
            ...
            <span style={highlight}>다만 🌾 쌀포인트는 현금으로 변환하실 수 없습니다.</span>
          </div>
        </section>

        <section id="응모" style={{ marginBottom: 56, scrollMarginTop: 140 }}>
          <h2 style={sectionTitle}>
            <TicketIcon size={26} weight="fill" color="var(--accent)" /> 응모
          </h2>
          <div style={box()}>
            ...
            <span style={highlight}>각각의 응모들은 제한 시간이 정해져 있으며, 해당 시간 내에 조건이 만족되지 않아 진행되지 않으면 자동으로 사라집니다.</span>
        ...
        <section id="쿠지" style={{ marginBottom: 56, scrollMarginTop: 140 }}>
          <h2 style={sectionTitle}>
            <GiftIcon size={26} weight="fill" color="var(--accent)" /> 쿠지
          </h2>
          <div style={box()}>
        ...
        <section id="상점" style={{ marginBottom: 56, scrollMarginTop: 140 }}>
          <h2 style={sectionTitle}>
            <StorefrontIcon size={26} weight="fill" color="var(--accent)" /> 상점
          </h2>
          <div style={box()}>
            ...
            <span style={highlight}>이때 만든 응모 또한, 일정 시간 동안 성사되지 않는다면 자동으로 사라집니다.</span>
          </div>
        </section>
