  ...
  return (
    <div className="home-neon">
      <div className="home-container" style={{ maxWidth: 800 }}>
        ...
        <h1 style={{ fontSize: 48, fontWeight: 800, color: '#eafcff', marginBottom: 20, textShadow: '0 0 24px #22d3ee66' }}>
          천운
        </h1>
        <p style={pStyle}>
        ...
        <section style={{ marginBottom: 64 }}>
          <h2 style={{ fontSize: 30, fontWeight: 700, color: '#eafcff', marginBottom: 20 }}>
            🎟 포인트
          </h2>
          <p style={pStyle}>
            ...
            <span style={{ ...sentenceStyle, fontWeight: 700, color: '#eafcff' }}>언제든 남은 🎰 운포인트는 현금으로 다시 변환하실 수 있습니다.</span>
          </p>
          <p style={pStyle}>
            ...
            <span style={{ ...sentenceStyle, fontWeight: 700, color: '#eafcff' }}>다만 🌾 쌀포인트는 현금으로 변환하실 수 없습니다.</span>
          </p>
        </section>

        <section id="응모" style={{ marginBottom: 64, scrollMarginTop: 140 }}>
          <h2 style={{ fontSize: 30, fontWeight: 700, color: '#eafcff', marginBottom: 20 }}>
            🎰 응모
          </h2>
          <p style={pStyle}>
            ...
            <span style={{ ...sentenceStyle, fontWeight: 700, color: '#eafcff' }}>다만, 1인이 한 응모에서 여러 장의 응모권을 구매한 경우에 당첨 시 나머지 응모권에 대한 🌾 쌀포인트는 지급되지 않습니다.</span>
            ...
            <span style={{ ...sentenceStyle, fontWeight: 700, color: '#eafcff' }}>각각의 응모들은 제한 시간이 정해져 있으며, 해당 시간 내에 조건이 만족되지 않아 진행되지 않으면 자동으로 사라집니다.</span>
        ...
        <section id="쿠지" style={{ marginBottom: 64, scrollMarginTop: 140 }}>
          <h2 style={{ fontSize: 30, fontWeight: 700, color: '#eafcff', marginBottom: 20 }}>
            🎁 쿠지
          </h2>
          <p style={pStyle}>
        ...
        <section id="상점" style={{ marginBottom: 64, scrollMarginTop: 140 }}>
          <h2 style={{ fontSize: 30, fontWeight: 700, color: '#eafcff', marginBottom: 20 }}>
            🏪 상점
          </h2>
          <p style={pStyle}>
            ...
            <span style={{ ...sentenceStyle, fontWeight: 700, color: '#eafcff' }}>이때 만든 응모 또한, 일정 시간 동안 성사되지 않는다면 자동으로 사라집니다.</span>
          </p>
        </section>
